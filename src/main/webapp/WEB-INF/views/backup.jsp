...
<div id="bg">
    <div id="outer">
        ...
        <div id="main">
            <div id="sidebar">
                ...
                <ul class="linkedList">
                    <li class="first">
                        <a href="#">Vitae et suspendisse integer dolore</a>
                    </li>
                    <li>
                        <a href="#">Molestie magnis sed amet nascetur</a>
                    </li>
                    <li>
                        <a href="#">Augue sagittis dolor</a>
                    </li>
                    <li>
                        <a href="#">Orci lectus leo urna</a>
                    </li>
                    <li>
                        <a href="#">Odio volutpat vivamus</a>
                    </li>
                    <li class="last">
                        <a href="#">Porttitor fermentum amet commodo</a>
                    </li>
                </ul>
                <h3>
                    Varius
                ...
                <div class="dateList">
                    <ul class="linkedList">
                        <li class="first">
                            <a href="#">Sapien et nascetur</a>
                        </li>
                        <li>
                            <a href="#">Nascetur sed vivamus</a>
                        </li>
                        <li>
                            <a href="#">Nisi amet et sagittis</a>
                        </li>
                        <li>
                            <a href="#">Duis cras lorem odio</a>
                        </li>
                        <li class="last">
                            <a href="#">Sed consequat purus</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div id="copyright">
        © Your Site Name | Design: <a href="http://templated.org/free-css-templates/seriousface/">Serious Face</a> by <a href="http://nodethirtythree.com">nodethirtythree</a> + <a href="http://templated.org/">Templated.org</a>
    </div>
</div>
